<p align="center">
  <img src=https://github.com/user-attachments/assets/0cf6fbc0-3da6-4d2a-a698-baedb115c825>
</p>


# Conversor de Monedas 💵💱💶

Challenge Conversor de Monedas, desafío propuesto por Alura Latam, para la especialización Back-End.

## Descripción 📝

Proyecto desarrolla para realizar Conversiones de Monedas desarrollado en el lenguaje de programación Java, el cual permite convertir diferentes divisas, utilizando una API de tasas de cambio en tiempo real. Con este conversor, se pueden realizar solicitudes a la API, analizar la respuesta JSON, filtrar las monedas de interés y mostrar los resultados a los usuarios de manera clara y concisa. Además, la aplicación guarda un historial de conversiones que incluye una marca de tiempo para cada consulta, lo que permite al usuario realizar un seguimiento de sus conversiones anteriores y ver cuándo y a qué hora se realizaron.
...
## 👨‍💻 Desarrollado por
- Walter Oswaldo Estacio Rodriguez
